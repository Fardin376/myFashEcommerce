                    ...
                    >
                      ...
                      <div className="flex gap-5">
                        <button
                          ...
                          } mt-5 inline-flex rounded-md justify-center bg-black px-4 py-2 text-md font-medium uppercase tracking-wide text-white`}
                        >
                          {item.isProcessing
                            ? 'Order is Processing'
                            : 'Order is delivered'}
                        ...
                        <button
                          ...
                          className={`${
                            !item.isProcessing ? 'opacity-50' : 'hoverEffect'
                          } mt-5 inline-flex rounded-lg justify-center bg-black px-4 py-2 text-md font-medium uppercase tracking-wide text-white`}
                        >
                          {componentLevelLoader &&
